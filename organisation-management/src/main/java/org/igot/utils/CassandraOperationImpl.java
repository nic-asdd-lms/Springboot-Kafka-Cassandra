...
import org.igot.utils.CassandraConnectionManager;
import org.igot.utils.CassandraConnectionMngrFactory;
...
public class CassandraOperationImpl implements CassandraOperation {
    ...
    public ApiResponse insertRecord(String keyspaceName, String tableName, Map<String, Object> request) {
        ...
        queryBuilder.append(String.join(",", keySet) + Constants.VALUES_WITH_BRACE);
        ...
        queryBuilder.append(commaSepValueBuilder + Constants.CLOSING_BRACE);
    ...
    @Override
    public ApiResponse insertBulkRecord(String keyspaceName, String tableName, List<Map<String, Object>> request) {
        ApiResponse response = new ApiResponse();
        try {
